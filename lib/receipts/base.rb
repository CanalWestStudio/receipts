module Receipts
  class Base < Prawn::Document
    ...
    def render_line_items(line_items, margin_top: 16)
      ...
      # table(line_items, width: bounds.width, column_widths: {0 => 100}, cell_style: {border_color: "e5e5e5", inline_format: true, overflow: :expand}) do
      table(line_items, width: bounds.width, cell_style: {border_color: "e5e5e5", inline_format: true, overflow: :expand}) do
        cells.padding = 6
        cells.borders = []
